...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav bg-gradient-success sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="#">
        ...
        <div class="sidebar-brand-text mx-3">Medical Records</div>
      </a>
 ...
 <!-- Divider -->
      ...
      <!-- Nav Item - for Medical Records Table (link for specific page)-->
      <li class="nav-item active">
       ...
       sa loob ng file name na config.php sa bandang baba makikita yan
        ...
        <?php echo base_url(); ?>
         ...
         Medical Records Table pupunta yung request sa admissioncontrol.php
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>addusercontrol/adduserview">
          ...
          <span>Healthcare Personnel</span></a>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy;Final Project PBKK (B) 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
