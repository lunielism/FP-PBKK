            ...
            <div class="p-5">
              <div class="text-center">
                <img width="70" height="70" src="<?php echo base_url(); ?>img/rizal.png"><br><br>
                 <h6><b>Lumina Medical Center</b></h6>
                 <h1 class="h4 text-gray-900 mb-4">Medical Records Tracking System </h1>
              </div>
              ...
              <div class="text-center">
                <a style="color: black; text-decoration: none" class="small" href="<?php echo base_url(); ?>standardusercontrol/standarduserview">Login using Standard account</a>
              </div>
